...
<body class="bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-gray-100 min-h-screen transition-colors duration-200">
    ...
    <!-- BARRA SUPERIOR RESPONSIVA CON BOTÓN HAMBURGUESA -->
    <header class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 sticky top-0 z-30 px-4 py-3 flex items-center justify-between shadow-sm">
        ...
        <div class="flex items-center gap-3">
            ...
            <button onclick="toggleTheme()" class="flex items-center gap-2 px-3 py-1.5 rounded-lg text-xs font-semibold bg-gray-100 dark:bg-slate-700 text-gray-700 dark:text-amber-400 border border-gray-300 dark:border-slate-600 hover:opacity-80 transition">
    ...
    <div class="flex relative min-h-[calc(100vh-57px)]">
        <!-- OVERLAY PARA MOBILE -->
        ...
        <!-- SIDEBAR TIPO HAMBURGUESA / DESPLEGABLE -->
        <aside id="sidebar" class="fixed md:static inset-y-0 left-0 z-50 w-64 bg-white dark:bg-slate-800 border-r border-gray-200 dark:border-slate-700 flex flex-col justify-between p-6 transition-transform duration-300 -translate-x-full md:translate-x-0 shadow-lg md:shadow-none">
            <div>
        ...
        <main class="flex-1 p-4 md:p-8 bg-gray-50 dark:bg-slate-900 transition-colors duration-200 min-w-0">
            @yield('content')
        </main>
    </div>
